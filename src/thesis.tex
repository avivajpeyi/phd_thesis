\documentclass[a4paper, 11pt, oneside, dvipsnames]{thesis}
...
\hypersetup{urlcolor=NavyBlue, linkcolor=NavyBlue,citecolor=NavyBlue,colorlinks=true}  % Colours hyperlinks in blue, but this can be distracting if there are many links.
...
% \input{chapters/appendix_imbh}
\input{chapters/appendix_energy}
