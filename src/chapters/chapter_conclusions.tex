...
\begin{center}
  ...
  \caption{\textbf{LIGO A+, CE and LISA Comparisons:} Left -- \citet{Jani:2020:NatAs}'s predicted cosmological reach to equal-size, non-spinning black hole binaries with the LIGO A+, CE and LISA gravitational wave observatories, with a minimum signal to noise ratio of 8. Right -- the LIGO A+, CE and LISA sensitivity curves. \github{https://github.com/avivajpeyi/cbc_gw_catalog_plotter}}
